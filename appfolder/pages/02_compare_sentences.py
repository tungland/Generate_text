...
with sentence_col:
    sentences = st.text_area("Angi noen setninger eller små tekster skilt med retur (ny linje)", st.session_state['text'], key = 'text')
    sentences = sentences.split('\n')

#with cluster_num_col:
#    cluster_num = st.number_input("Hvor mange clustre?", min_value=2, max_value=20, value=5)
